...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            root = new JSONObject(EARTHQUAKES_JSON_RESPONSE);
        ...
        for(int i = 0; i < earthquakesArray.length(); i++){
            JSONObject firstEarthQuake = earthquakesArray.optJSONObject(i);

            JSONObject quakeProperties = firstEarthQuake.optJSONObject("properties");
            ...
            String url = quakeProperties.optString("url");

            earthquakes.add(i, new Earthquake(magnitude, place, timeMilliSec, url));
        };
